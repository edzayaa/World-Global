...
import { InFromLeft, InFromRight } from "@/shared/components/animated-container/libs/Animations";
...
export const Section1 = () => {
    ...
    return (
        <ViewSection className={styles["section-1"]} padding>
            <div className="section-1-wrapper">
                <div className="bg-wrapper">
                    <ItemSvg signalStart={signalInView} />
                </div>
                <div className="content">
                    <AnimatedContainer className="title" inSignal={signalInView} animationIn={InFromLeft} delay={100} >
                        <h1>Global Leader in Synthetic Roofing</h1>
                    </AnimatedContainer>
                    <AnimatedContainer className="card-container" inSignal={signalInView} animationIn={InFromRight} delay={100}>
                        <Card color={{color: 'black', alpha: '60'}}>
