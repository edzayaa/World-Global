...
//   const navigateTo = (e: MouseEvent<HTMLAnchorElement>, url: string) => {
//     e.preventDefault()
//     router.push(url)
//   }
  ...
  const toggleProductDropdown = (e: MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault()
  ...
  return (
    <nav className="navbar blur_bg">
      ...
      <div className="wrapper">
       <button id="toggleBtn" onClick={toggleProductDropdown} href="#" className={`link toggleBtn ${pathName.startsWith('/product/') ? 'active' : ''}`}>
          Product 
